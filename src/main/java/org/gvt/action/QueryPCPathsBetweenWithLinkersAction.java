 ...
 *
 */
public class QueryPCPathsBetweenWithLinkersAction extends QueryPCAction
{
	private String[] symbols;

	public QueryPCPathsBetweenWithLinkersAction(ChisioMain main, QueryLocation qLoc, String... symbols)
	{
		super(main, "Paths Between With Linkers...", false, qLoc);
	...
	public QueryPCPathsBetweenWithLinkersAction(ChisioMain main, boolean useSelected, QueryLocation qLoc)
	{
		super(main, "Paths Between With Linkers...", useSelected, qLoc);
	}
	...
	{
		return AlgoRunner.searchPathsBetweenSIFWithLinkers(
